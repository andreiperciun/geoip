...
/**
 * @file
 * Contains \Drupal\geoip\Plugin\GeoLocator\Local.
 */
...
class Local extends GeoLocatorBase {
  ...
  public function geolocate($ip_address) {
    ...
    try {
      ...
      \Drupal::logger('geoip')->error($this->t('The Maxmind database reader reported an invalid or corrupt database.'));
      return NULL;
    }
  }
  ...
  public function setScheme($scheme) {
    ...
    // Should we throw an exception if invalid scheme?
